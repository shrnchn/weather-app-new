$(function() {
    ...
    var getGeo = function() {
        ...
        function success(position) {
            ...
            var apiURLCoords = 'http://api.wunderground.com/api/' + apiKey + '/conditions/q/' + geo.lat + ',' + geo.lng + '.json';
  ...
  //   var getWeatherCoordinates = function(geo.lat, geo.lng) {

		// getGeo();
        
  //       var apiKey = '0aea82cb2d20d5dc';

  //       var apiURLCoords = 'http://api.wunderground.com/api/' + apiKey + '/forecast/geolookup/conditions/q/' + geo.lat + ',' + geo.lng + '.json';
